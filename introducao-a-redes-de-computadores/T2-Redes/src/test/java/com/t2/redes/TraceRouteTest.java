...
class TraceRouteTest {
    ...
    void test2() {
        ...
        assertEquals("n1 ->> r1 : ICMP Echo Request<br/>src=160.10.128.10 dst=240.20.10.10 ttl=3", run.get(10));
        assertEquals("r1 ->> r2 : ICMP Echo Request<br/>src=160.10.128.10 dst=240.20.10.10 ttl=2", run.get(11));
        assertEquals("Note over r2 : ARP Request<br/>Who has 240.20.10.10? Tell 240.20.0.1", run.get(12));
        assertEquals("n2 ->> r2 : ARP Reply<br/>240.20.10.10 is at 00:00:00:00:00:02", run.get(13));
        assertEquals("r2 ->> n2 : ICMP Echo Request<br/>src=160.10.128.10 dst=240.20.10.10 ttl=1", run.get(14));
        assertEquals("n2 ->> r2 : ICMP Echo Reply<br/>src=240.20.10.10 dst=160.10.128.10 ttl=8", run.get(15));
        assertEquals("r2 ->> r1 : ICMP Echo Reply<br/>src=240.20.10.10 dst=160.10.128.10 ttl=7", run.get(16));
        assertEquals("r1 ->> n1 : ICMP Echo Reply<br/>src=240.20.10.10 dst=160.10.128.10 ttl=6", run.get(17));
    }
    ...
    void test3() {
        ...
        assertEquals("r1 ->> n1 : ICMP Time Exceeded<br/>src=10.0.0.1 dst=10.0.0.10 ttl=8", run.get(3));
        assertEquals("n1 ->> r1 : ICMP Echo Request<br/>src=10.0.0.10 dst=40.0.0.10 ttl=2", run.get(4));
        assertEquals("Note over r1 : ARP Request<br/>Who has 20.0.0.2? Tell 20.0.0.1", run.get(5));
        assertEquals("r2 ->> r1 : ARP Reply<br/>20.0.0.2 is at 00:00:00:00:00:20", run.get(6));
        assertEquals("r1 ->> r2 : ICMP Echo Request<br/>src=10.0.0.10 dst=40.0.0.10 ttl=1", run.get(7));
        assertEquals("r2 ->> r1 : ICMP Time Exceeded<br/>src=20.0.0.2 dst=10.0.0.10 ttl=8", run.get(8));
        assertEquals("r1 ->> n1 : ICMP Time Exceeded<br/>src=20.0.0.2 dst=10.0.0.10 ttl=7", run.get(9));
        assertEquals("n1 ->> r1 : ICMP Echo Request<br/>src=10.0.0.10 dst=40.0.0.10 ttl=3", run.get(10));
        assertEquals("r1 ->> r2 : ICMP Echo Request<br/>src=10.0.0.10 dst=40.0.0.10 ttl=2", run.get(11));
        assertEquals("Note over r2 : ARP Request<br/>Who has 30.0.0.2? Tell 30.0.0.1", run.get(12));
        assertEquals("r3 ->> r2 : ARP Reply<br/>30.0.0.2 is at 00:00:00:00:00:30", run.get(13));
        assertEquals("r2 ->> r3 : ICMP Echo Request<br/>src=10.0.0.10 dst=40.0.0.10 ttl=1", run.get(14));
        assertEquals("Note over r3 : ARP Request<br/>Who has 50.0.0.1? Tell 50.0.0.2", run.get(15));
        assertEquals("r1 ->> r3 : ARP Reply<br/>50.0.0.1 is at 00:00:00:00:00:12", run.get(16));
        assertEquals("r3 ->> r1 : ICMP Time Exceeded<br/>src=50.0.0.2 dst=10.0.0.10 ttl=8", run.get(17));
        assertEquals("r1 ->> n1 : ICMP Time Exceeded<br/>src=50.0.0.2 dst=10.0.0.10 ttl=7", run.get(18));
        assertEquals("n1 ->> r1 : ICMP Echo Request<br/>src=10.0.0.10 dst=40.0.0.10 ttl=4", run.get(19));
        assertEquals("r1 ->> r2 : ICMP Echo Request<br/>src=10.0.0.10 dst=40.0.0.10 ttl=3", run.get(20));
        assertEquals("r2 ->> r3 : ICMP Echo Request<br/>src=10.0.0.10 dst=40.0.0.10 ttl=2", run.get(21));
        assertEquals("Note over r3 : ARP Request<br/>Who has 40.0.0.10? Tell 40.0.0.1", run.get(22));
        assertEquals("n2 ->> r3 : ARP Reply<br/>40.0.0.10 is at 00:00:00:00:00:02", run.get(23));
        assertEquals("r3 ->> n2 : ICMP Echo Request<br/>src=10.0.0.10 dst=40.0.0.10 ttl=1", run.get(24));
        assertEquals("n2 ->> r3 : ICMP Echo Reply<br/>src=40.0.0.10 dst=10.0.0.10 ttl=8", run.get(25));
        assertEquals("r3 ->> r1 : ICMP Echo Reply<br/>src=40.0.0.10 dst=10.0.0.10 ttl=7", run.get(26));
        assertEquals("r1 ->> n1 : ICMP Echo Reply<br/>src=40.0.0.10 dst=10.0.0.10 ttl=6", run.get(27));
    }
    ...
    void test4() {
        ...
        assertEquals("r2 ->> r1 : ARP Reply<br/>20.0.0.2 is at 00:00:00:00:00:20", run.get(6));
        assertEquals("r1 ->> r2 : ICMP Echo Request<br/>src=10.0.0.10 dst=40.0.0.10 ttl=1", run.get(7));
        assertEquals("Note over r2 : ARP Request<br/>Who has 30.0.0.2? Tell 30.0.0.1", run.get(8));
